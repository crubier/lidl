...
affectationLinking;var _lodash = require('lodash');var _lodash2 = _interopRequireDefault(_lodash);var _interfaces = require('../interfaces');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function affectationLinking(graph) {
  ...
  function (theResult, theNode) {
    ...
    if (!(0, _interfaces.isUndefined)(theNode.ports[1]) && !(0, _interfaces.isUndefined)(theNode.ports[2])) {
      if ((0, _interfaces.madeOnlyOf)(theNode.ports[1]) === 'out' && (0, _interfaces.madeOnlyOf)(theNode.ports[2]) === 'in') {
        var source =
        graph.
        addNode({
          type: 'InteractionInstance',
        ...
        graph.
        finish(theNode);
      } else if ((0, _interfaces.madeOnlyOf)(theNode.ports[1]) === 'in' && (0, _interfaces.madeOnlyOf)(theNode.ports[2]) === 'out') {
        var _source =
        graph.
        addNode({
          type: 'InteractionInstance',
        ...
        graph.
        finish(theNode);
      } else if ((0, _interfaces.madeOnlyOf)(theNode.ports[1]) === 'in' && (0, _interfaces.madeOnlyOf)(theNode.ports[2]) === 'in') {
        // The affectation node does not make sense
        //TODO throw errors maybe
        graph.
        finish(theNode);
      } else if ((0, _interfaces.madeOnlyOf)(theNode.ports[1]) === 'out' && (0, _interfaces.madeOnlyOf)(theNode.ports[2]) === 'out') {
