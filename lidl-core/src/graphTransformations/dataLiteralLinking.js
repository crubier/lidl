...
export default function dataLiteralLinking(graph) {
  graph.reduceNodes(
    { type: "InteractionInstance", content: { operatorType: "Activation" } },
    (theResult, theNode) => {
  ...
  graph.reduceNodes(
    { type: "InteractionInstance", content: { operatorType: "Boolean" } },
    (theResult, theNode) => {
      let literal = theNode.content.operator;
      let source = graph.addNode({
        type: "InteractionInstance",
  ...
  graph.reduceNodes(
    { type: "InteractionInstance", content: { operatorType: "Number" } },
    (theResult, theNode) => {
      let literal = theNode.content.operator;
      let source = graph.addNode({
        type: "InteractionInstance",
  ...
  graph.reduceNodes(
    { type: "InteractionInstance", content: { operatorType: "Text" } },
    (theResult, theNode) => {
      let literal = theNode.content.operator;
      let source = graph.addNode({
        type: "InteractionInstance",
