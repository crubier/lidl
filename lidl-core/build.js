...
examplecontent += "module.exports={\nheader:`" + fs.readFileSync(commonHeader, {
  encoding: 'utf8'
}) + "\n`,\n";
examplecontent += "lidl:[";
...
fileName: '" + ffile + "',\n\
     code : `" + fs.readFileSync(path.join(ffile, "code.lidl"), {
    encoding: 'utf8'
  }) + "`,\n\
     scenario : `" + fs.readFileSync(path.join(ffile, 'scenario.json'), {
    encoding: 'utf8'
  }) + "`\n\
}")
  .join(',');
examplecontent += "]\n};";
fs.writeFileSync('./src/examples.js', examplecontent, {
  encoding: 'utf8'
})
