...
describe("interfaces", function () {
  ...
  describe("localisationInterface", function () {
    it("simple ok", function () {
      expect(
        interfaces.localisationInterface(
          parse("Number in", {
            startRule: "interfac",
          }),
        ),
  ...
  describe("globalisationInterface", function () {
    it("simple ok", function () {
      expect(
        interfaces.globalisationInterface(
          parse("Number in", {
            startRule: "interfac",
          }),
        ),
  ...
  describe("mergeInterface", function () {
    ...
    it("simple ok 4", function () {
      expect(
        ...
        parse("{x:Number in,y:Number out,a:Text in,b: Text out}", {
          startRule: "interfac",
        }),
      );
    });
    it("simple ok 5", function () {
      expect(
        ...
        parse("{x:Number in,y:Number in,z:Text in}", {
          startRule: "interfac",
        }),
      );
    });
    ...
    it("simple ok 7", function () {
      expect(interfaces.mergeInterface(undefined, undefined)).toBeUndefined();
    });
  });
  ...
  describe("subInterface", function () {
    ...
    it("simple ok3", function () {
      expect(
        interfaces.subInterface(
          parse(
            "{z:Boolean in,a:{x:Text in,y:Text out, z:Number in},b:Number out}",
            {
              startRule: "interfac",
            },
          ),
        ...
        parse("{x:Text in,y:Text out, z:Number in}", {
          startRule: "interfac",
        }),
      );
    });
    it("simple ok4", function () {
      expect(
        ...
        parse("{x:Text out,y:Text out, z:Number out}", {
          startRule: "interfac",
        }),
      );
    });
