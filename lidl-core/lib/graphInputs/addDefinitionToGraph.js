...
addDefinitionToGraph;var _lodash = require('lodash');var _lodash2 = _interopRequireDefault(_lodash);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function addDefinitionToGraph(graph, definition) {
  if (definition.type === 'InteractionDefinition') {
    return addInteractionDefinitionToGraph(graph, definition);} else 
  if (definition.type === 'InterfaceDefinition') {
...
function addInterfaceDefinitionToGraph(graph, definition) {
  ...
  var interfacNode = addInterfaceToGraph(graph, definition.interfac, definition.signature, rootNode);
