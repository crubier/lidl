  ...
  render() {
    ...
    return (
      <div className="TraceViewer">
        ...
        <Table groupHeaderHeight={30} headerHeight={30} height={this.props.tableHeight} overflowX={controlledScrolling ? "hidden" : "auto"} overflowY={controlledScrolling ? "hidden" : "auto"} rowGetter={this._rowGetter.bind(this)} rowHeight={30} rowsCount={this.props.scenario.length} scrollLeft={this.props.left} scrollTop={this.props.top} width={650}>
