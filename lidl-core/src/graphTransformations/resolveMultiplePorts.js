...
import { madeOnlyOf, conjugateInterface } from "../interfaces";
        ...
        _(similarInputEdges)
          .forEach((similarEdge, index) => {
            code =
              ...
              "%>;\n} else if (<%=a" +
              (index + 1) +
              "%> !== null){\n  throw new Error('Multiple active assignments to the same signal <%=a0%> : '+<%=a0%> + ' and ' + <%=a" +
              (index + 1) +
              "%>);\n}";
